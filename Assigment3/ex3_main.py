...
def blendDemo():
    im1 = cv2.cvtColor(cv2.imread('pictures/sunset.jpg'), cv2.COLOR_BGR2RGB) / 255
    im2 = cv2.cvtColor(cv2.imread('pictures/cat.jpg'), cv2.COLOR_BGR2RGB) / 255
    mask = cv2.cvtColor(cv2.imread('pictures/mask_cat.jpg'), cv2.COLOR_BGR2RGB) / 255
...
def main():
    print(ID())
    img_path = 'pictures/boxman.jpg'
    lkDemo(img_path)
    pyrGaussianDemo('pictures/pyr_bit.jpg')
    pyrLaplacianDemo('pictures/pyr_bit.jpg')
    blendDemo()
